...
#define STRING_CONFIG_H_AUTHOR "(ArmyGuy255A, CR-10)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ABNSMURF 4.2.7"
...
#define HOMING_FEEDRATE_MM_M { (20*100), (20*100), (4*100) }
